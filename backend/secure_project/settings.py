...
Configuración segura y profesional para aplicación de cifrado y autenticación.
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='secure_app_db'),
        'USER': config('DATABASE_USER', default='postgres'),
        'PASSWORD': config('DATABASE_PASSWORD', default='paulo12345'),
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': config('JWT_SECRET_KEY', default='your-jwt-secret-key-here'),
    'VERIFYING_KEY': None,
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para aplicación segura con autenticación JWT y cifrado',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'secure_app.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
